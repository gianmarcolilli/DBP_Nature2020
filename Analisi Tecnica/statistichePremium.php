...
<?php
  ...
  require("mongo.php");*/
?>
<h2 class="text-dark">Classifica degli utenti premium in base alla loro affidabilità</h2>
	<div class="row">
...
classifTotali,
affidabilita,
contatore from utente where tipo='premium' order by affidabilita desc ";
