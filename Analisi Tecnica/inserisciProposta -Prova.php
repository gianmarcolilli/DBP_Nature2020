        ...
        <form action="inserisciProposta_do.php" method="post">
          <div class="form-row">
            <div class="form-group col-4">
              <label for="insert">Proposta N°</label>
              <?php		
							unset($idP);
      						$sql= "select id from proposta";
      						try {
							...
							$idP=$s+2;
      				?>
              <input type="text" class="form-control-plaintext text-uppercase" name="id" value="<?= $idP ?>" readonly>
            </div>
            <div class="form-group col-4">
              <label for="insert">ID segnalazione di riferimento</label>
              <input type="text" class="form-control-plaintext text-uppercase" name="idS" value="2" readonly>
            </div>
            ...
            <div class="form-group col-8">
              <label for="insert">Commento</label>
			      ...
			      <div class="form-group col-4">
              <label for="updateClasse"> Data proposta</label>
              <input type="text" class="form-control-plaintext" name="dataProposta" value="<?= date("d/m/y")?>" readonly>
            </div>
