...
<?php
  ...
  require("mongo.php");*/
?>
<h2 class="text-dark">Classifica degli utenti più attivi in base alle segnalazioni inserite</h2>
	<div class="row">
		
			<a href="elencoUtenti.php"><p class="lead mb-0 col-12 "><i class="fa fa-address-book"></i> Elenco utenti</p></a>
			<a href="statistichePremium.php"><p class="lead mb-0 col-12"><i class="fa fa-clipboard-list"></i> Classifica utenti premium più affidabili</p></a>
...
classifTotali,
affidabilita,
contatore from utente where contatore!='0' order by contatore desc ";
